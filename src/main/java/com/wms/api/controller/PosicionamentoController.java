...
public class PosicionamentoController {
	...
	@Autowired
	private StatusMovimentacaoRepository statusMovimentacaoRepository;
	...
	public ResponseEntity<ControleEntradaProdutoPorPosicao/* Dto */> cadastrar(
		...
		service.posicionaProduto(prodPosicaoRepository, posicionamentoform.getEtiquetaProduto(),
				...
				tarefaPosicionamentoRepository, nfProdutoRepository, nfProdutoPorPosicaoRepository, ProdutoRepository,
				statusMovimentacaoRepository);
